...
?>
  ...
  <!-- o painel mais vendidos entrarão aqui dentro -->
  <section class="painel mais-vendidos">
<h2> Novo Produto</h2>
<h3> <?php if(isset($_GET['erro'])) echo "Preencha os campos corretamente, as imagens devem ser do tipo jpg ou png"; ?> </h3>
<div id="formulario">
<form name="cadastro_u" method="post" action="adm.php?acao=gravar_p" enctype="multipart/form-data">
	<ul>
        <li>
        ...
        <li>
            ...
            <input type="text" size="40" id="email" name="preco" required />
        </li>
        <li>
        ...
        <li>
            ...
            <textarea cols="50" rows="5" id="message" name="descricao"></textarea>
		</li>
	</ul>
    <p>
